package net.icraftsystems.app.auth.android.mysqlrecycler.Adapter;
...
import net.icraftsystems.app.auth.android.mysqlrecycler.AnimationActivity;
import net.icraftsystems.app.auth.android.mysqlrecycler.Model.Animation;
import net.icraftsystems.app.auth.android.mysqlrecycler.R;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    private List<Animation> mData ;
    RequestOptions option;


    public RecyclerViewAdapter(Context mContext, List<Animation> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, AnimationActivity.class);
